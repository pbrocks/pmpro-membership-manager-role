...
function pmprommr_setup_role() {
	...
	add_role(
		'pmpro_membership_manager', 'Membership Manager', array(
...
function pmprommr_plugin_row_meta( $links, $file ) {
	if ( strpos( $file, 'pmpro-membership-manager-role.php' ) !== false ) {
		$new_links = array(
			'<a href="' . esc_url( 'https://www.paidmembershipspro.com/add-ons/pmpro-membership-manager-role/' ) . '" title="' . esc_attr( __( 'View Documentation', 'paid-memberships-pro' ) ) . '">' . __( 'Docs', 'paid-memberships-pro' ) . '</a>',
